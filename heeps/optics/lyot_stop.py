...
def lyot_stop(wf, ls_mask=None, f_lyot_stop='', ngrid=1024, npupil=285, 
        ...
        ls_misalign=None, verbose=False, **conf):
    ...
    if mode in ['CVC', 'RAVC', 'CLC']:
        ...
        # case 3: create a lyot stop mask
            ...
            # create Lyot stop
            ls_mask = create_ls(d_ext, d_int, npupil=npupil, dRext=dRext, 
                dRint=dRint, dRspi=dRspi, misalign_x=misalign_x, 
                misalign_y=misalign_y, circ_ext=circ_ext, circ_int=circ_int, **conf)
            if verbose is True:
